...
import { getDoc, getFirestore,query,collection,where, doc } from 'firebase/firestore';
...
return (
    ...
    <ItemDetail productDetail={productDetail} loading={loading} error={error}></ItemDetail>
    </Box>
